...
-(void)executePresentationAnimation:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    [UIView animateWithDuration:self.presentationDuration delay:0.0f usingSpringWithDamping:0.5f initialSpringVelocity:4.0f options:UIViewAnimationOptionCurveEaseIn animations:^{
