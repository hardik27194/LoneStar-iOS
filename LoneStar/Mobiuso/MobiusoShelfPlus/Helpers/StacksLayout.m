...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)path
{
    ...
    ModuleLayoutAttributes* attributes = [ModuleLayoutAttributes layoutAttributesForCellWithIndexPath:path];
    ...
    if (self.isPinching)
    {
        ...
        {
            int itemCount = (int) self.itemFrames.count;
...
-(NSArray*)layoutAttributesForElementsInRect:(CGRect)rect
{
    ...
    for (int stack = 0; stack < self.numberOfStacks; stack++)
    {
        ...
        if (CGRectIntersectsRect(stackFrame, rect))
        {
            ...
            [attributes addObject:[self layoutAttributesForSupplementaryViewOfKind:[SmallModuleTypeHeader kind] atIndexPath:[NSIndexPath indexPathForItem:0 inSection:stack]]];
        }
    }
...
- (void)prepareItemsLayout
{
    ...
    int numberOfItems = (int) [self.collectionView numberOfItemsInSection:self.pinchedStackIndex];
