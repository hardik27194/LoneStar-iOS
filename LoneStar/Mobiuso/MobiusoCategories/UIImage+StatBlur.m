...
/*!
 ...
 @class UIImage+StatBlur
 
 @discussion 
 Using the fast blur algorithm, blur the image to a given value (known as radius).  Useful to covert images for background where
 the foreground (text, etc) needs to be sharper as compared to the background for a crisper view (photoshop techniques).
...
#import "UIImage+StatBlur.h"


@implementation  UIImage (StatBlur)


// Stackblur algorithm - for fast blurring
// from
...
- (UIImage*) statBlur: (NSUInteger)inradius
{
