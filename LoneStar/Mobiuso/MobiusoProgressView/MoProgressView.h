...
//  MoProgressView.h
//  Created - Sandeep
//  Based on MBProgressHUD by Matej Bukovinski on 2.4.09.
//
...
@protocol MoProgressViewDelegate;


typedef enum {
	/** Progress is shown using an UIActivityIndicatorView. This is the default. */
	MoProgressViewModeIndeterminate,
	/** Progress is shown using a round, pie-chart like, progress view. */
	MoProgressViewModeDeterminate,
	/** Progress is shown using a ring-shaped progress view. */
	MoProgressViewModeAnnularDeterminate,
	/** Shows a custom view */
	MoProgressViewCustomView,
	/** Shows only labels */
	MoProgressViewModeText
} MoProgressViewMode;

typedef enum {
	/** Opacity animation */
	MoProgressViewAnimationFade,
	/** Opacity + scale animation */
	MoProgressViewAnimationZoom
} MoProgressViewAnimation;


#ifndef MO_STRONG
#if __has_feature(objc_arc)
	#define MO_STRONG strong
#else
	#define MO_STRONG retain
#endif
#endif
	...
	#define MO_WEAK unsafe_unretained
#else
	#define MO_WEAK assign
#endif
#endif

#if NS_BLOCKS_AVAILABLE
typedef void (^MoProgressViewCompletionBlock)();
#endif
 ...
 * @see showAnimated:whileExecutingBlock:onQueue:completion:
 */
- (void)showAnimated:(BOOL)animated whileExecutingBlock:(dispatch_block_t)block completionBlock:(MoProgressViewCompletionBlock)completion;
 ...
 */
@property (copy) MoProgressViewCompletionBlock completionBlock;
 ...
 */
@property (assign) MoProgressViewMode mode;
 ...
 */
@property (assign) MoProgressViewAnimation animationType;

/**
 * The UIView (e.g., a UIImageView) to be shown when the HUD is in MBProgressHUDModeCustomView.
 * For best results use a 37 by 37 pixel view (so the bounds match the built in indicator bounds). 
 */
@property (MO_STRONG) UIView *customView;
 ...
 */
@property (MO_WEAK) id<MoProgressViewDelegate> delegate;
 ...
 */
@property (MO_STRONG) UIFont* labelFont;

/** 
 * Font to be used for the details label. Set this property if the default is not adequate. 
 */
@property (MO_STRONG) UIFont* detailsLabelFont;
...
@protocol MoProgressViewDelegate <NSObject>
