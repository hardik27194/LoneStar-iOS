...
@IBDesignable class ADVSegmentedControl: UIControl {
    ...
    @IBInspectable var unselectedLabelColor : UIColor = UIColor(red: (0x92/0xff), green: (0xda/0xff), blue: (0x0d/0xff), alpha: 1.0) {  // was whiteColor
        didSet {
            setSelectedColors()
        }
    }
    
    @IBInspectable var thumbColor : UIColor = UIColor(red: (0x92/0xff), green: (0xda/0xff), blue: (0x0d/0xff), alpha: 1.0) // 92da0d     UIColor(white: 1.0, alpha: 0.5) // UIColor.whiteColor() 
        {
        didSet {
            setSelectedColors()
        }
    ...
    func setupView(){
        ...
        layer.borderColor =  UIColor(red: (0x92/0xff), green: (0xda/0xff), blue: (0x0d/0xff), alpha: 0.7).CGColor // 92da0d     UIColor(white: 1.0, alpha: 0.5).CGColor
        layer.borderWidth = 2
        
        backgroundColor =  UIColor.whiteColor() // was clearColor
    ...
    func setupLabels(){
        ...
        for index in 1...items.count {
            ...
            let label = UILabel(frame: CGRectMake(0, 0, 70, 44))
    ...
    override func layoutSubviews() {
        ...
        displayNewSelectedIndex()   // causes a flicker - not sure how to handle
