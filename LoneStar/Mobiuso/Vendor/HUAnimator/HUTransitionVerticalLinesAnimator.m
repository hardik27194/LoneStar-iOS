...
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning>)transitionContext {
    return VLANIMATION_TIME1+self.animationDuration /*VLANIMATION_TIME2*/;
}

- (HUTransitionVerticalLinesAnimator *) init
{
    if ((self=[super init]) != nil) {
        self.animationDuration = VLANIMATION_TIME2;
    }
    return self;
}
#define VLINEWIDTH 12.0
/**
