...
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning>)transitionContext {
    return HLANIMATION_TIME1+self.animationDuration /*HLANIMATION_TIME2*/;
}

- (HUTransitionHorizontalLinesAnimator *) init
{
    if ((self=[super init]) != nil) {
        self.animationDuration = HLANIMATION_TIME2;
    }
    return self;
}


#define HLINEHEIGHT 12.0
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    [UIView animateWithDuration:HLANIMATION_TIME1 delay:0.0 options:UIViewAnimationOptionCurveEaseIn animations:^{
        ...
        [UIView animateWithDuration:self.animationDuration delay:0 usingSpringWithDamping:0.8 initialSpringVelocity:0 options:UIViewAnimationOptionCurveEaseIn animations:^{
